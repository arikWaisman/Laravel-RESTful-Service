        ...
        return(
            <div>
                ...
                <div>
                    ...
                    {console.log(meetingData.meeting.users)}
                    {!meetingData.meeting.users.some( (user) => { return user.id == this.props.userId; }) ? <button onClick={(e) => this.registration()} >Register to meeting</button> : <div><h2>You're Registered</h2><button onClick={(e) => this.registration(false)}>Un-register</button></div>}
